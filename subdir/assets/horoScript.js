...
function showHoroscope(horoscope, luckyNum, color){
    textArea.innerHTML = "<p>"+ "<b> Today's Horoscope: </b>"+"<br>"+horoscope+"</span>" +"<br>"+ "Your lucky Number for today is <span STYLE='font-weight:bold'>"+ luckyNum + "</span> <br>"+"Your color for today is <span STYLE='font-weight:bold'>"+ color+"</span></p>";
